...
export const NZ_CODE_EDITOR_CONFIG = new InjectionToken<CodeEditorConfig>('code-editor-config', {
  providedIn: 'root',
  factory: NZ_CODE_EDITOR_CONFIG_FACTORY
});

export function NZ_CODE_EDITOR_CONFIG_FACTORY(): CodeEditorConfig {
  return {};
}
